...
monotone relations are AP-reducible to the \cds\ problem. We generalize the observation by
Theorem~\ref{theorem:monotone}\@.

\begin{theorem} [Hedayaty, Bulatov 2009 Unpublished]\label{theorem:monotone}
...
Theorem~\ref{theorem:trichotomy} is simpler than our proof; hence, there is no need to 
...
By Lemma~\ref{lem:linear} we have \chom(\mH) \mapge\ \cds\@.
\end{proof}
