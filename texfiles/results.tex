...
Now, for \(H'=H_2 - a\), we have  \chom(\(H'\)) \maple \ccsp(\setof{R,S}) \maple
...
\begin{figure}
\centering
\subfigure[\(N_5\)]{\input{figs/n5.pdftex}\label{fig:n5}}\hfill
\subfigure[\(M_5\)]{\input{figs/m5.pdftex}\label{fig:m5}}\hfill
\subfigure[\(C_6\)]{\input{figs/c6.pdftex}\label{fig:c6}}
