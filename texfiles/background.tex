...
consequently, the complexity of the CSP\((\relset)\) only depends on the \(Pol(\relset)\)\@.
\end{cor}
...
that \(Pol(\relset)\) can also express the complexity of the \ccsp(\mrelset) problem.
