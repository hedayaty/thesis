...
in charge of complexity of approximation of the problem \ccsp(\mrelset).
The relation between weak co-clones and partial polymorphisms,
implies that the complexity of approximation of the problem \ccsp(\mrelset)  
...
the problem \pname{\#Dual-SAT} defined as :
...
for sampling the problem \pname{Dual-SAT}. 
\begin{algorithm}[h]
\begin{algorithmic}
\WHILE {true}
...
Since the problem \pname{\#Dual-SAT} is self-reducible, Theorem~\ref{thm:selfred} implies
...
Goldberg and Jerrum \cite{Goldberg2007} proved that the \pname{Ferromagnetic Ising} problem 
is AP-interreducible with the \cbis\ problem and 
Goldberg et al.~\cite{Leslie03} proved that the \pname{\#2-Wrench-Coloring} and
