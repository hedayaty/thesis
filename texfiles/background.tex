...
\begin{theorem} [Jerrum et al. 1986 \cite{JVV}] \label{thrm:selfred}
For any self-reducible relation \mR, the almost uniform generation problem and the approximate counting problem have the same complexity.
\end{theorem}

Here we provide a very informal 
proof for the problem of finding the number of truth assignment for a CNF\@.
The general idea of the proof for Theorem~\ref{thrm:selfred} is the same.
Let \(C\) be a CNF\@.
