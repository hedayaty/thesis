\chapter{Monotone Reflexive Graphs}
...
One of the problems that relate homomorphisms to proper interval graphs is the minimum cost homomorphism problem.
...
\begin{defi} [Cartesian product of graphs]
...
for partial orders.
\begin{defi} [Cartesian product of partial orders]
...
Lemma~\ref{lem:prod} will show that we can generate monotone graphs from products of other
monotone graphs.
