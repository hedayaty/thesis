...
The problem \pname{\#Dual-SAT} is solved by sampling and the \pname{\#Match} and problems 
...
In Chapter~\ref{chp:results}, we focused on AP-reductions involving the problem \cbis\@.
