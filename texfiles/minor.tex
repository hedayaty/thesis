...
Most of the results in this chapter are published in \cite{mvl}, \cite{maxi}\@. 
...
\begin{lemma}[Bulatov and Hedayaty \cite{mvl}] \label{lem:connected}
...
\begin{lemma} [Bulatov and Hedayaty \cite{mvl}] \label{lem:linear}
...
\begin{lemma} [Bulatov and Hedayaty \cite{mvl}] \label{lem:logarithm}
Let \(\varphi\) be a polynomial time computable function that maps every instance of a
counting problem \(A\) to an instance of a counting problem problem \(B\) in such a way that
...
\begin{lemma} [Bulatov and Hedayaty \cite{mvl}] \label{lem:projection}
...
\begin{lemma} [Pinning and reflexive elements, Bulatov and Hedayaty \cite{mvl}] \label{lem:refpin}
...
\begin{lemma}[Extended Pinning, Bulatov and Hedayaty \cite{mvl}]\label{lem:pinning}
...
\begin{theorem}[Maximization, Bulatov and Hedayaty \cite{mvl}]\label{theo:max}
Let \mrelset\ be a set of relations over the domain \mD,
