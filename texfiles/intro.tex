...
have presented several results on the relation between complexity of CSP(\mrelset) and \(Pol(\relset)\); however, the CSP dichotomy still remains an open problem. \todo{Add more Papers}
...
\begin{theorem} [Goldberg et al. \cite{Leslie03}]\label{theorem:thrichotomy}
...
\subfigure[\(Wr_2\)]{\input{figs/Wr2.pdftex}\label{fig:Wr2}}\hspace{4cm}
...
\begin{figure}[h]
\centering 
\subfigure[\(S^*_1\)]{\input{figs/wr1.pdftex}\label{fig:ss1}}\hspace{5cm}
\subfigure[\(S^*_2\)]{\input{figs/wr2.pdftex}\label{fig:ss2}}\\
\subfigure[\(S^*_3\)]{\input{figs/wr3.pdftex}\label{fig:ss3}}\hspace{5cm}
...
\subfigure[Oriented \(P_4\)] {\input{figs/dp4.pdftex}\label{fig:dp4}}\\
